...
<head>
    ...
    <style>
        ...
        *{
        ...
        .scheme:hover{
            color:#D3F8E1 ;
            /* background-color: rgb(19, 101, 55); */
            box-shadow: 2px 2px -100px rgb(18, 17, 17);
            scale: 1.02;
        }
        .image{
            height: 80%s;
...
<body>
    ...
    <div class="menu-bar">
        <ul>
            ...
            <li><a href="../Scheme/scheme.php" style="color: seagreen;">Scheme</a></li>
    ...
    <div class="scheme-box">
        <div class="scheme">
            <a href="../Scheme/Bhausaheb_Fundkar.php">
                <img src="../Images/BFFLS.jpeg" class="image">
                <h4>Bhausaheb Fundkar Falbag Lagvad Scheme</h4>
            </a>
        </div>
        <div class="scheme">
            <a href="../Scheme/OMPS.php">
                <img src="../Images/OMPS.jpeg" class="image">
                <h4>Opening And Maintenance Of Public School For Vimukta Jatis And Nomadic Tribes</h4>
            </a>
        </div>
        <div class="scheme">
            <a href="../Scheme/GMSASSAY.php">
                <img src="../Images/GMSASSY.jpeg" class="image">
                <h4>Gopinath Munde Shetkari Apghat Suraksha Sanugrah Audhan Yojana</h4>
            </a>
        </div>
        <div class="scheme">
            <a href="../Scheme/CMAFPS.php">
                <img src="../Images/CMAFPS.jpeg" class="image">
                <h4>Chief Minister Agriculture and Food Processing Scheme</h4>
            </a>
        </div>
        <div class="scheme">
            <a href="../Scheme/NDKSP.php">
                <img src="../Images/KSP.jpg" class="image">
                <h4>Nanaji Deshmukh Krishi Sanjivani Prakalp</h4>
            </a>
        </div>
        <div class="scheme">
            <a href="../Scheme/NSMNY.php">
                <img src="../Images/NSMNY.jpeg" class="image">
                <h4>Namo Shetkari Mahasanman Nidhi Yojana</h4>
            </a>
        </div>
        <div class="scheme">
            <a href="../Scheme/KVDGSSY.php">
                <img src="../Images/Karmaveer-Dadasaheb-Gaikwad.png" class="image">
                <h4>Karma Veer Dadasaheb Gaikwad Sabalikaran & Swabhiman Yojana</h4>
            </a>
        </div>
        <div class="scheme">
            <a href="../Scheme/CMSAIS.php">
                <img src="../Images/AIS.webp" class="image">
                <h4>Chief Minister Sustainable Agriculture Irrigation Scheme</h4>
            </a>
        </div>
    </div>
